...
use In2pire\Cli\Command\HelpCommand;
use In2pire\Cli\Command\BashCompletionCommand;
...
class Application extends \Symfony\Component\Console\Application
{
     ...
     * {@inheritdoc}
     */
    public function __construct($name = 'UNKNOWN', $version = 'UNKNOWN', $description = null, $alias = null)
    {
    ...
    protected function getDefaultInputDefinition()
    {
        ...
        $definition->addOption(new InputOption('--bash-completion', null, InputOption::VALUE_NONE, 'Generate bash completion for application'));
        return $definition;
    }
...
HEADERS;
        ...
        if (!empty($this->alias)) {
            $completion .= "complete -F _$appId " . $this->alias . PHP_EOL;
        }
